...
export default function CartItemsPart({ itemDetials }) {
	...
	return (
		<>
			<div className="Fredoka relative w-[85%] min-h-[140px] max-h-[80%] bg-[rgb(36,36,36)] rounded-3xl p-6 flex items-center flex-col sm:flex-row md:center  text-White gap-2 md:gap-4">
				...
				<div className='relative w-[100%] max-w-[140px] h-full'>
					<img src={itemDetials.img} alt="itemImage" className='w-fit h-[150px] object-fit min-w-[60px] rounded-[16px]' />
				</div>
					...
					<div className='w-full h-full min-h-[140px] center flex-col'>
						<div className='w-full h-full flex justify-start gap-1'>
							<div className='flex justify-start items-start flex-col md:flex-row w-full'>
								<h3 className='text-[16px] md3:text-2xl font-medium truncate max-w-[calc(100%-30px)]'>{itemDetials.title}</h3>
							</div>
						</div>
