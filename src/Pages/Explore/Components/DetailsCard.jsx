...
export default function DetialsCard() {
    ...
    return (
        <>
            <div className="relative center w-full md:w-80 h-96 bg-Beige2 shadow-lg rounded-lg flex-col overflow-hidden group Fredoka border border-Black/15">
                ...
                <div className="relative w-full h-full overflow-hidden">
                    ...
                    <img src={Giraffe} className='imgSettings w-full h-full group-hover:scale-105 transition-all duration-300 ease-in-out' alt='LoadingImg' />
                </div>
