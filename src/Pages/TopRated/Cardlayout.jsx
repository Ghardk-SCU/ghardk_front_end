...
export default function Cardlayout({ details, top }) {
  ...
  return (
    <div
      ...
      }} className='col-span-2 sm:col-span-1 center text-white NunitoSans text-2xl font-bold md:pr-4'>#{top<10 && '0'}{top}
      </div>
      <div className='col-span-6 sm:col-span-8 md:col-span-2 items-center text-white flex gap-x-4 md:pr-4'>
      ...
      <div className='col-span-2 sm:col-span-1 center text-white px-2'>
