...
export default function ForYou({ FirstColor: LeftTopColor, SecondColor: RightBottomColor, setFirstColor: setLeftTopColor, setSecondColor: setRightBottomColor }) {
  ...
  return (
    <div ref={bigContainer} className='w-full min-h-[300vh]'>
      <main ref={mainRef} className="sticky top-0 grid lg:grid-cols-2 w-full lg:max-h-[120vh] min-h-[120vh] overflow-hidden">
        <motion.div animate={{ backgroundColor: LeftTopColor, transition: { duration: 0.5 } }} className="relative overflow-hidden">
          ...
          <div ref={TextLeftTopY} className='pointer-events-none absolute h-auto w-full lg:w-auto lg:h-screen 
            -bottom-20 lg:-bottom-0
            lg:top-5
          right-0 translate-x-0 lg:translate-x-[50%] center lg:-rotate-90'>
        ...
        <motion.div animate={{ backgroundColor: RightBottomColor, transition: { duration: 0.5 } }} className="relative h-full w-full overflow-hidden z-[2]">
          <div ref={TextRightBottomY} className='pointer-events-none absolute h-auto w-full lg:w-auto lg:h-screen -top-24 lg:-top-0 left-0 -translate-x-0 lg:-translate-x-[50%] center lg:-rotate-90'>
