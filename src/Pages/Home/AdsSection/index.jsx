...
export default function AdsSection() {
  ...
  return (
    <div className="relative w-full h-screen center">
  ...
  return (
    <>
      <div className='absolute left-10 bottom-1/4'>
        <button className='text-white self-end bg-Black rounded-full py-4 px-6 sm:py-7 sm:px-12
      ...
      {imgTurn > 0 && <div className='absolute left-10 top-1/2 -translate-y-1/2'>
      ...
      {imgTurn < AdsLength - 1 && <div className='absolute right-10 top-1/2 -translate-y-1/2'>
